...
const RESERVED_TOP_LEVEL_SLUGS = [
  ...
  '.well-known',
  'api',
  // v1.2.1 Part A: the three site-wide legal pages (see
  // routes/public.js's GET /privacy-policy, /terms, /cookie-policy,
  // registered before GET /:seoSlug the same way every route above is).
  'privacy-policy',
  'terms',
  'cookie-policy'
];
